			...
			this.importObject = {
				go: {
					...
					"syscall/js.valueIndex": (sp) => {
						sp >>>= 0;
						storeValue(sp + 24, loadValue(sp + 8)[getInt64(sp + 16)]);
					},
					...
					"syscall/js.valueCall": (sp) => {
						...
						try {
							...
							const m = v[loadString(sp + 16)];
							const args = loadSliceOfValues(sp + 32);
							const result = Function.apply.call(m, v, args);
							sp = this._inst.exports.getsp() >>> 0; // see comment above
					...
					"syscall/js.valueInvoke": (sp) => {
						...
						try {
							...
							const result = Function.apply.call(v, undefined, args);
							sp = this._inst.exports.getsp() >>> 0; // see comment above
